...
import { Icon56InfoOutline, Icon28MenuOutline } from '@vkontakte/icons';

const Home = ({ id, fetchedToken, onGroupClick, goToMenu }) => {
  ...
  if (isLoading) {
    return (
      <Panel id={id}>
        ...
        <ScreenSpinner size='large' caption='Загружаем данные о группах'>Загружаем данные о группах...</ScreenSpinner>
      </Panel>
    );
  }
